	...
	public void sendMessage(Boolean syn, final Boolean bro, PDU pdu, String addr)throws IOException {
	    ...
	    if (version == SnmpConstants.version3) {
	        ...
	        if (version == SnmpConstants.version1) {
	             ...
	             ((CommunityTarget) target).setCommunity(new OctetString("public")); //可修改成public
	          }	 
	     }
	     // 目标对象相关设置
	...
	public static void main(String[] args) {
        ...
        try {
              ...
              // manager.sendMessage(false, true, pdu, "udp:192.168.1.229/161");//192.168.1.229 Linux服务器
                 manager.sendMessage(false, true, pdu, "udp:10.82.17.87/161");//192.168.1.233 WinServer2008服务器
            } catch (IOException e) {
            e.printStackTrace();
          }
	 }
